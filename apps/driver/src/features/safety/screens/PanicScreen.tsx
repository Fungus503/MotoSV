...
export function DriverPanicScreen() {
    ...
    return (
      <View className="flex-1 bg-surface items-center justify-center px-6" style={{ paddingTop: insets.top }}>
        ...
        <Text className="text-onSurfaceVariant text-base text-center mb-8">
          Tu alerta ha sido recibida por nuestro equipo de seguridad.
        </Text>
      ...
      <View className="px-4 flex-1">
        {alertTypes.map((type) => (
          <TouchableOpacity
            ...
            className={`flex-row items-center p-4 rounded-2xl mb-3 ${selectedType === type.id ? `${type.color} bg-opacity-20` : 'bg-surfaceContainerLow'}`}
          >
